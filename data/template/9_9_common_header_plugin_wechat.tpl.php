...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1470663208, '9', './data/template/9_9_common_header_plugin_wechat.tpl.php', './template/xinyun_door_001', 'common/header_plugin_wechat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1470663208, '9', './data/template/9_9_common_header_plugin_wechat.tpl.php', './template/xinyun_door_001', 'common/header_plugin_wechat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1470663208, '9', './data/template/9_9_common_header_plugin_wechat.tpl.php', './template/xinyun_door_001', 'common/header_plugin_wechat')
;?>
