...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1471346582, '9', './data/template/9_9_common_header_member_register.tpl.php', './template/xinyun_door_001', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1471346582, '9', './data/template/9_9_common_header_member_register.tpl.php', './template/xinyun_door_001', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1471346582, '9', './data/template/9_9_common_header_member_register.tpl.php', './template/xinyun_door_001', 'common/header_member_register')
;?>
