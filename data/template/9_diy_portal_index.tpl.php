...
0
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index.htm', './template/default/common/header.htm', 1471456781, 'diy', './data/template/9_diy_portal_index.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index.htm', './template/default/common/footer.htm', 1471456781, 'diy', './data/template/9_diy_portal_index.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index.htm', './template/default/common/header_common.htm', 1471456781, 'diy', './data/template/9_diy_portal_index.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index.htm', './template/default/common/header_qmenu.htm', 1471456781, 'diy', './data/template/9_diy_portal_index.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index.htm', './template/default/common/pubsearchform.htm', 1471456781, 'diy', './data/template/9_diy_portal_index.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index')
;
...
<div id="wp" class="wp">
<style id="diy_style" type="text/css">#portal_block_188 {  margin:10px !important;}#portal_block_190 .dxb_bc {  color:#333333 !important;font-size:20px !important;}</style>
<div class="wp">
<!--[diy=diy200]--><div id="diy200" class="area"><div id="framesBg55k" class="frame move-span cl frame-1"><div id="framesBg55k_left" class="column frame-1-c"><div id="framesBg55k_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<div class="cl wp" style="margin-top:10px;">
    <div class="xinyun_oneleft_boxone">
    <!--[diy=xinyun_door_001_10]--><div id="xinyun_door_001_10" class="area"><div id="framertZeiE" class="frame move-span cl frame-1"><div id="framertZeiE_left" class="column frame-1-c"><div id="framertZeiE_left_temp" class="move-span temp"></div><?php block_display('189');?></div></div><div id="frameLfuRfh" class="frame move-span cl frame-1"><div id="frameLfuRfh_left" class="column frame-1-c"><div id="frameLfuRfh_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
    </div>
</div>
<div class="cl wp mt8 xinyun_photo">
     <h2 class="xinyun_title"><strong>精彩热门</strong><span class="more"><a href="#" target="_blank">更多</a></span></h2>
     <!--[diy=xinyun_door_001_23]--><div id="xinyun_door_001_23" class="area"><div id="framenTnJpZ" class="frame move-span cl frame-1-1"><div id="framenTnJpZ_left" class="column frame-1-1-l"><div id="framenTnJpZ_left_temp" class="move-span temp"></div><?php block_display('190');?></div><div id="framenTnJpZ_center" class="column frame-1-1-r"><div id="framenTnJpZ_center_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<div class="cl wp mt8 xinyun_link mb8">
     <h2 class="xinyun_title"><strong>友情链接</strong><span class="more"></span></h2>
     <!--[diy=xinyun_door_001_24]--><div id="xinyun_door_001_24" class="area"><div id="frameFhUBXY" class="frame move-span cl frame-1"><div id="frameFhUBXY_left" class="column frame-1-c"><div id="frameFhUBXY_left_temp" class="move-span temp"></div><?php block_display('188');?><div id="frameiw52fS" class="frame move-span cl frame-1"><div id="frameiw52fS_left" class="column frame-1-c"><div id="frameiw52fS_left_temp" class="move-span temp"></div></div></div></div></div><div id="framej7910p" class="frame move-span cl frame-1"><div id="framej7910p_left" class="column frame-1-c"><div id="framej7910p_left_temp" class="move-span temp"></div><div id="frameXZ6stT" class="frame move-span cl frame-1"><div id="frameXZ6stT_left" class="column frame-1-c"><div id="frameXZ6stT_left_temp" class="move-span temp"></div></div></div></div></div></div><!--[/diy]-->
</div>
<div class="wp">
