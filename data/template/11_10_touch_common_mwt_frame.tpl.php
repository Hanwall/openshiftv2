...
<head>
  ...
  <script src="<?php echo $_G['style']['directory'];?>/touch/static/dist-1469933220/base.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
</body>
</html>
...
sitelogo : '<?php echo $_G['siteurl'];?>static/image/mobile/images/logo.png',
    ...
    require.config({
        baseUrl: dz.stylepath+"/touch/static/dist-1469933220/",
        packages: [
