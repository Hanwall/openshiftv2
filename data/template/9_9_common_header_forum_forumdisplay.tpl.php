...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1471890857, '9', './data/template/9_9_common_header_forum_forumdisplay.tpl.php', './template/xinyun_door_001', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1471890857, '9', './data/template/9_9_common_header_forum_forumdisplay.tpl.php', './template/xinyun_door_001', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1471890857, '9', './data/template/9_9_common_header_forum_forumdisplay.tpl.php', './template/xinyun_door_001', 'common/header_forum_forumdisplay')
;?>
