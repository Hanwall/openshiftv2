...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1471346592, '9', './data/template/9_9_common_header_home_space.tpl.php', './template/xinyun_door_001', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1471346592, '9', './data/template/9_9_common_header_home_space.tpl.php', './template/xinyun_door_001', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1471346592, '9', './data/template/9_9_common_header_home_space.tpl.php', './template/xinyun_door_001', 'common/header_home_space')
;?>
