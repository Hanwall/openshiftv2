...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1471895593, '9', './data/template/9_9_common_header_connect_login.tpl.php', './template/xinyun_door_001', 'common/header_connect_login')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1471895593, '9', './data/template/9_9_common_header_connect_login.tpl.php', './template/xinyun_door_001', 'common/header_connect_login')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1471895593, '9', './data/template/9_9_common_header_connect_login.tpl.php', './template/xinyun_door_001', 'common/header_connect_login')
;?>
