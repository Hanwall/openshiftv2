...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1470740837, '9', './data/template/9_9_common_header_portal_view.tpl.php', './template/xinyun_door_001', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1470740837, '9', './data/template/9_9_common_header_portal_view.tpl.php', './template/xinyun_door_001', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1470740837, '9', './data/template/9_9_common_header_portal_view.tpl.php', './template/xinyun_door_001', 'common/header_portal_view')
;?>
