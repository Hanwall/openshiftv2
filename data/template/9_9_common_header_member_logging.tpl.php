...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1471347012, '9', './data/template/9_9_common_header_member_logging.tpl.php', './template/xinyun_door_001', 'common/header_member_logging')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1471347012, '9', './data/template/9_9_common_header_member_logging.tpl.php', './template/xinyun_door_001', 'common/header_member_logging')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1471347012, '9', './data/template/9_9_common_header_member_logging.tpl.php', './template/xinyun_door_001', 'common/header_member_logging')
;?>
